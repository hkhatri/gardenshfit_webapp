...
//    } );
    ...
    $('#unreadmsgs_table tbody td a.view').live('click', function () {
        ...
        if ( view_unread_row !== null && view_unread_row != nTr ) {
            ...
            $.ajax({
            type:"POST",
            url:"http://localhost:8888/index.php/message/updatenotif",
   ...
   // alert(nTr);
      ...
      //alert(aData[6]);
        ...
        $.ajax({
            type:"POST",
            url:"http://localhost:8888/index.php/message/deletenotif",
            data:{name:usern, timestamp:aData[6]},
            success: function(response)
            {
   ...
   // alert(nTr);
            ...
            "Send": function() {
                ...
                if ( bValid ) {
                    //code to send a reply
                        $.ajax({
                          type:"POST",
                          url:"http://localhost:8888/index.php/message/sendreply",
    ...
    var nTr = $(this).parents('tr')[0];
      ...
      var aData = oTable1.fnGetData( nTr );
        ...
        $.ajax({
            type:"POST",
            url:"http://localhost:8888/index.php/message/deletenotif_read",
            data:{name:usern, timestamp:aData[6]},
            success: function(response)
            {
